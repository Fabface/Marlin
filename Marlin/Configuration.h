...
#define STRING_CONFIG_H_AUTHOR "(Fabface - 17.03.2025 - SKR3 EZ)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Duplicator"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 16.24f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1543f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0694f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0695f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKi 8.57
  #define DEFAULT_bedKd 231.87
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 3220, 3220, 6453, 3080.8064598496 } //E-Steps = 96.2752018703/16*256 (96.2752018703 is from original duplicator firmware and is with 1/16 mircostepping)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 75, 2000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 45, 00, -0.2 }
...
#define MANUAL_X_HOME_POS -131
#define MANUAL_Y_HOME_POS  -69
